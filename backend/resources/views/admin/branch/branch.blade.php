                            ...
                            <tbody>
                                @foreach ($allBranch as $key => $item)
                                    <tr>
                                        <td>{{ ++$key }}</td>
                                        <td>{{ $item['name'] }}</td>
                                        <td class="text-center"><a class="btn btn-warning" href="{{route('admin.branch.show_edit', ['id' => $item->id])}}">Sửa</a> <a
                                                class="btn btn-danger" href="{{route('admin.branch.delete', ['id' => $item->id])}}"
